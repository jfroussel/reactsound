            ...
            <div className="container-fluid pt-5">
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-8"><PlaylistTable uid={this.state.uid} projectID={this.props.match.params.id} listID={!this.state.selectedOption ? project.playlist : listID} /></div>
